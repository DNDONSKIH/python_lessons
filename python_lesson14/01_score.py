...
if __name__ == '__main__':
    arg_parser = argparse.ArgumentParser(description='сервис расчета результата игры в боулинг')
    arg_parser.add_argument('--result', type=str, default='', help='строка с результатом')
    args = arg_parser.parse_args()
    if args:
        score = get_score(args.result)
        print('score = ', score)
